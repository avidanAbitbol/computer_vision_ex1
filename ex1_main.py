...
def main():
    ...
    img_path1 = 'images1.jpg'
    '''
    img_path2 = 'images2.jpg'
   '''
    ...
    '''
    img1 = imReadAndConvert(img_path1, LOAD_RGB)
    yiq_img1 = transformRGB2YIQ(img1)
    f, ax = plt.subplots(1, 2)
    ax[0].imshow(img1)
    ax[1].imshow(yiq_img1)
    plt.show()
    yiq_img2 = transformYIQ2RGB(yiq_img1)
    f, ax = plt.subplots(1, 2)
    ax[0].imshow(img1)
    ...
    # Image histEq
    '''
    histEqDemo(img_path2, LOAD_GRAY_SCALE)
    histEqDemo(img_path2, LOAD_RGB)
    '''
    ...
    '''
    quantDemo(img_path2, LOAD_GRAY_SCALE)
    quantDemo(img_path2, LOAD_RGB)
    '''
    # Gamma
